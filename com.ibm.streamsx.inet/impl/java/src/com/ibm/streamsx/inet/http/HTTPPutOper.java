...
@PrimitiveOperator(name=HTTPPutOper.OPER_NAME, description=HTTPPutOper.DESC)
@Libraries(value={"opt/downloaded/*"})
@Icons(location32="impl/java/icons/HTTPPost_32.gif", location16="impl/java/icons/HTTPPost_16.gif")
public class HTTPPutOper extends AbstractOperator  
{
	static final String CLASS_NAME="com.ibm.streamsx.inet.http.HTTPPutOper";
	static final String OPER_NAME = "HTTPPut";
	...
	public static void checkInConsistentRegion(OperatorContextChecker checker) {
		...
		if(consistentRegionContext != null && consistentRegionContext.isStartOfRegion()) {
			checker.setInvalidContext( HTTPPutOper.OPER_NAME + " operator cannot be placed at the start of a consistent region.", 
					new String[] {});
		}
	}
